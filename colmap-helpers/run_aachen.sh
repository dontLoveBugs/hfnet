...
image_dir="/data/vldata/aachen/images_upright"
sift_db="/data/vldata/aachen/achen.db"
new_db="aachen-new.db"
npz_dir="/data/vlexpr/exports/superpoint/aachen_sfm/db/"
nvm_file="/data/vldata/aachen/3D-models/aachen_cvpr2018_db.nvm"

match_ratio="87"
match_file="matches${match_ratio}.txt"

temp_model="aachen_temp_model"
final_model="aachen_my_superpoint_model"
